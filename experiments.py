from training_functions import train_wo_transfer_learning, evaluate_model, pretrain, evaluate_multiclass, get_ucr_data, perform_transfer_learning
import optuna
...
def tl_objective(trial):
    ...
    fine_train_loss, fine_val_loss, preterm_val, finetuned_model = perform_transfer_learning("/Users/yarianrango/Documents/School/Master-AI-VU/Thesis/data/UCRArchive_2018/ECG5000/ECG5000_TRAIN.tsv", 0.3, params)
